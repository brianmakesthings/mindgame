...
execute 'pip3 install Flask==1.1.2' do
  creates "#{python3_packages}/flask/__init__.py"
end
execute 'pip3 install Flask-SocketIO==4.3.1' do
  creates "#{python3_packages}/flask-socketio/__init__.py"
end
# Ruby bunny library
...
#end
# Go amqp library
execute 'export GOPATH=/home/vagrant/project/project; go get github.com/streadway/amqp github.com/google/uuid' do
  cwd '/home/vagrant/project/project/src'
  user username
  environment 'HOME' => user_home
  creates user_home + '/project/project/src/github.com/streadway/amqp/README.md'
end
# Java amqp library
